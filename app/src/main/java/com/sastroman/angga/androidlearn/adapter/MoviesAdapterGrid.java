...
public class MoviesAdapterGrid extends RecyclerView.Adapter<MoviesAdapterGrid.MovieViewHolder> implements Filterable {
    ...
    public MoviesAdapterGrid(List<Movie> movies, Context context) {
        this.movies = movies;
    ...
    @Override
    public MoviesAdapterGrid.MovieViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
