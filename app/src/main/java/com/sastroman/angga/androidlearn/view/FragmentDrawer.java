...
import com.sastroman.angga.androidlearn.adapter.NavigationDrawerAdapter;
import com.sastroman.angga.androidlearn.view.addon.MyDividerItemDecoration;
...
import com.sastroman.angga.androidlearn.model.NavDrawerItem;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

import static com.sastroman.angga.androidlearn.view.addon.MyDividerItemDecoration.VERTICAL_LIST;
...
public class FragmentDrawer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addItemDecoration(new MyDividerItemDecoration(getContext(),VERTICAL_LIST, 20));
